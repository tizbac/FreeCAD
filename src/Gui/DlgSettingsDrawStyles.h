 ...
 * This class is auto generated by Gui/DlgSettingsDrawStyles.py. Modify that file
 ...
 * @code
 *     python3 -m cogapp -r Gui/DlgSettingsDrawStyles.h Gui/DlgSettingsDrawStyles.cpp
 * @endcode
 */
